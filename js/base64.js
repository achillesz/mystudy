...
function base64Encode(str){
	...
	while(end == 0){
		...
		d = (typeof input[++ptr] != "undefied") ? input[ptr].charCodeAt(0) :((end += 1) ? 0 : 0);
		e = (typeof input[++ptr] != "undefied") ? input[ptr].charCodeAt(0) :((end += 1) ? 0 : 0);
		u = enc64List[c >> 2];
		v = enc64List[(0x00000003 & c) << 4] | d >> 4;
		w = enc64List[(0x0000000F & d) << 2] | d >> 6;
